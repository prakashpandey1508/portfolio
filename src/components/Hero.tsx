...
const Hero = () => {
  ...
  const randomEffect = () => {
    const original = "Prakash Pandey".split("");
    ...
    <div className="flex flex-col items-center justify-center h-[20rem] md:h-[26rem]  ">
     ...
     {!showTypeWriter ? (
      ...
      <div className="flex flex-col md:flex-row space-y-5 md:space-y-0 space-x-0 md:space-x-5">
        ...
        <a href="https://drive.google.com/file/d/1YTtyL-0dfovwmwnMHuivnGsjvHYNDuVU/view?usp=sharing" target="_blank" rel="noopener noreferrer" download>
